...
{
    [Route("api/service-replaced-parts")]
    [ApiController]
    public class ServiceReplacedPartController : ControllerBase
    {
        private readonly ServiceReplacedPartReadService _read;
        protected readonly CurrentUser _current;

        public ServiceReplacedPartController(ServiceReplacedPartReadService read, CurrentUser current)
        {
            _read = read;
            _current = current;
        }
